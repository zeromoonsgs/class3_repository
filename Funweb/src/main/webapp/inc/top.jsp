...
<!-- -------------------------------------------------------------------------------------------------- -->
  ...
  <nav id="top_menu">
  	<ul>
  		...
  		<li><a href="../company/welcome.jsp">NEOGURIWORLD</a></li>
  		<li><a href="../company/option.jsp">ATTRACTION</a></li>
  		<li><a href="../center/notice.jsp">NOTICEBOARD</a></li>
  		<li><a href="../directions/directions.jsp">DIRECTIONS</a></li>
  	</ul>
  </nav>
</header>
